...
exports.DcaFlag = exports.DcaAccount = void 0;
...
exports.DcaFlag = DcaFlag;

(function (DcaFlag) {
  DcaFlag[DcaFlag["SOL-MINT"] = 1] = "SOL-MINT";
  DcaFlag[DcaFlag["MINT-SOL"] = 2] = "MINT-SOL";
})(DcaFlag || (exports.DcaFlag = DcaFlag = {}));

var DcaAccount = /*#__PURE__*/function () {
  function DcaAccount(param) {
    _classCallCheck(this, DcaAccount);

    _defineProperty(this, "_totalAmount", void 0);

    _defineProperty(this, "_authority", void 0);

    _defineProperty(this, "_mintAddress", void 0);
    ...
    _defineProperty(this, "_flag", void 0);
    ...
    this._authority = new _web.PublicKey(param.authority);
    this._mintAddress = new _web.PublicKey(param.mintAddress);
  ...
  _createClass(DcaAccount, [{
    ...
    value: function decodeUnchecked(data) {
      return (0, _borsh.deserializeUnchecked)(dcaAccountSchema, this, data);
    }
    /**
    ...
    key: "getDcaAccountInfo",
    value: function () {
      var _getDcaAccountInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(connection, address, commitment) {
        var programId,
            info,
            dcaAcount,
            _args = arguments;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                programId = _args.length > 3 && _args[3] !== undefined ? _args[3] : _constants.DCA_PROGRAM_ID;
                _context.next = 3;
              ...
              case 8:
                dcaAcount = this.decodeUnchecked(info.data);
                return _context.abrupt("return", dcaAcount);
      ...
      function getDcaAccountInfo(_x, _x2, _x3) {
        return _getDcaAccountInfo.apply(this, arguments);
      }

      return getDcaAccountInfo;
    }()
  }]);
...
var dcaAccountSchema = new Map([[DcaAccount, {
  kind: "struct",
  fields: [["totalAmount", "u64"], ["authority", [32]], ["mintAddress", [32]], ["startTime", "u64"], ["dcaAmount", "u64"], ["dcaTime", "u64"], ["flag", "u8"], ["state", "u8"], ["minimumAmountOut", "u64"]]
}]]);

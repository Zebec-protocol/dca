...
var DcaAccount = /*#__PURE__*/function () {
  function DcaAccount(param) {
    ...
    _defineProperty(this, "_mintAddressFrom", void 0);

    _defineProperty(this, "_mintAddressTo", void 0);
    ...
    this._mintAddressFrom = new _web.PublicKey(param.mintAddressFrom);
    this._mintAddressTo = new _web.PublicKey(param.mintAddressTo);
    this._startTime = param.startTime;
    this._dcaAmount = new _amount.Amount(param.dcaAmount);
...
var dcaAccountSchema = new Map([[DcaAccount, {
  kind: "struct",
  fields: [["authority", [32]], ["mintAddressFrom", [32]], ["mintAddressTo", [32]], ["startTime", "u64"], ["dcaAmount", "u64"], ["frequency", "u64"], ["state", "u8"]]
}]]);

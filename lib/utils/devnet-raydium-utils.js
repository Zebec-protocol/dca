...
exports.findPoolIdByBaseAndQuoteMintDevnet = findPoolIdByBaseAndQuoteMintDevnet;
...
function _getAssociatedId() {
  _getAssociatedId = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0, _raydiumSdk.findProgramAddress)([programId.toBuffer(), marketId.toBuffer(), Buffer.from("amm_associated_seed", "utf-8")], programId);
...
function _getAssociatedAuthority() {
  _getAssociatedAuthority = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref2) {
    var programId;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", (0, _raydiumSdk.findProgramAddress)( // new Uint8Array(Buffer.from('amm authority'.replace('\u00A0', ' '), 'utf-8'))
...
function _getAssociatedBaseVault() {
  _getAssociatedBaseVault = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(_ref3) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return (0, _raydiumSdk.findProgramAddress)([programId.toBuffer(), marketId.toBuffer(), Buffer.from("coin_vault_associated_seed", "utf-8")], programId);
...
function _getAssociatedQuoteVault() {
  _getAssociatedQuoteVault = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(_ref4) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return (0, _raydiumSdk.findProgramAddress)([programId.toBuffer(), marketId.toBuffer(), Buffer.from("pc_vault_associated_seed", "utf-8")], programId);
...
function _getAssociatedLpMint() {
  _getAssociatedLpMint = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(_ref5) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return (0, _raydiumSdk.findProgramAddress)([programId.toBuffer(), marketId.toBuffer(), Buffer.from("lp_mint_associated_seed", "utf-8")], programId);
...
function _getAssociatedLpVault() {
  _getAssociatedLpVault = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(_ref6) {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 3;
            return (0, _raydiumSdk.findProgramAddress)([programId.toBuffer(), marketId.toBuffer(), Buffer.from("temp_lp_token_associated_seed", "utf-8")], programId);
...
function _getAssociatedTargetOrders() {
  _getAssociatedTargetOrders = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(_ref7) {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _context7.next = 3;
            return (0, _raydiumSdk.findProgramAddress)([programId.toBuffer(), marketId.toBuffer(), Buffer.from("target_associated_seed", "utf-8")], programId);
...
function _getAssociatedWithdrawQueue() {
  _getAssociatedWithdrawQueue = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(_ref8) {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _context8.next = 3;
            return (0, _raydiumSdk.findProgramAddress)([programId.toBuffer(), marketId.toBuffer(), Buffer.from("withdraw_associated_seed", "utf-8")], programId);
...
function _getAssociatedOpenOrders() {
  _getAssociatedOpenOrders = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(_ref9) {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            _context9.next = 3;
            return (0, _raydiumSdk.findProgramAddress)([programId.toBuffer(), marketId.toBuffer(), Buffer.from("open_order_associated_seed", "utf-8")], programId);
...
function _getAssociatedPoolKeys() {
  _getAssociatedPoolKeys = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(_ref10) {
    var version, marketId, baseMint, quoteMint, programId, id, lpMint, _yield$getAssociatedA, authority, nonce, baseVault, quoteVault, lpVault, openOrders, targetOrders, withdrawQueue, serumVersion, serumProgramId, _yield$Market$getAsso, marketAuthority;

    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            version = _ref10.version, marketId = _ref10.marketId, baseMint = _ref10.baseMint, quoteMint = _ref10.quoteMint;
...
function _fetchAllPoolKeysDevnet() {
  _fetchAllPoolKeysDevnet = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(connection, config) {
    var supported, poolsAccountInfo, flatPoolsAccountInfo, tempPoolsKeys, _iterator, _step, _step$value, pubkey, accountInfo, version, programId, serumVersion, serumProgramId, LIQUIDITY_STATE_LAYOUT, _data, fields, status, nonce, baseMint, quoteMint, lpMint, openOrders, targetOrders, baseVault, quoteVault, marketId, withdrawQueue, lpVault, associatedPoolKeys, marketsInfo, poolsKeys, index, poolKeys, marketInfo, id, marketVersion, data, _Market$getLayouts, MARKET_STATE_LAYOUT, _MARKET_STATE_LAYOUT$, marketBaseVault, marketQuoteVault, marketBids, marketAsks, marketEventQueue;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            _context11.prev = 2;
            _context11.next = 5;
            return Promise.all(supported.map(function (_ref11) {
          ...
          case 15:
            ...
            _step$value = _step.value, pubkey = _step$value.pubkey, accountInfo = _step$value.account, version = _step$value.version, programId = _step$value.programId, serumVersion = _step$value.serumVersion, serumProgramId = _step$value.serumProgramId, LIQUIDITY_STATE_LAYOUT = _step$value.stateLayout;
            _data = accountInfo.data;
            fields = LIQUIDITY_STATE_LAYOUT.decode(_data);
            status = fields.status, nonce = fields.nonce, baseMint = fields.baseMint, quoteMint = fields.quoteMint, lpMint = fields.lpMint, openOrders = fields.openOrders, targetOrders = fields.targetOrders, baseVault = fields.baseVault, quoteVault = fields.quoteVault, marketId = fields.marketId;
          ...
          case 38:
            ...
            _context11.prev = 39;
            _context11.next = 42;
            return (0, _raydiumSdk.getMultipleAccountsInfo)(connection, tempPoolsKeys.map(function (_ref12) {
          ...
          case 47:
            ...
            for (index in marketsInfo) {
              ...
              _Market$getLayouts = _raydiumSdk.Market.getLayouts(marketVersion), MARKET_STATE_LAYOUT = _Market$getLayouts.state;
              _MARKET_STATE_LAYOUT$ = MARKET_STATE_LAYOUT.decode(data), marketBaseVault = _MARKET_STATE_LAYOUT$.baseVault, marketQuoteVault = _MARKET_STATE_LAYOUT$.quoteVault, marketBids = _MARKET_STATE_LAYOUT$.bids, marketAsks = _MARKET_STATE_LAYOUT$.asks, marketEventQueue = _MARKET_STATE_LAYOUT$.eventQueue;
              poolsKeys.push(_objectSpread(_objectSpread({}, poolKeys), {
    ...
    }, _callee11, null, [[2, 8], [13, 32, 35, 38], [39, 45]]);
  }));
  return _fetchAllPoolKeysDevnet.apply(this, arguments);
}
...
function _fetchPoolKeysDevnet() {
  _fetchPoolKeysDevnet = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(connection, poolId) {
    var version,
        serumVersion,
        marketVersion,
        programId,
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          ...
          case 7:
            ...
            _Liquidity$getLayouts = _raydiumSdk.Liquidity.getLayouts(version), LiquidityStateLayout = _Liquidity$getLayouts.state; //@ts-ignore

            fields = LiquidityStateLayout.decode(Uint8Array.from(account.data));
            status = fields.status, baseMint = fields.baseMint, quoteMint = fields.quoteMint, lpMint = fields.lpMint, openOrders = fields.openOrders, targetOrders = fields.targetOrders, baseVault = fields.baseVault, quoteVault = fields.quoteVault, marketId = fields.marketId;
          ...
          case 18:
            ...
            _Market$getLayouts2 = _raydiumSdk.Market.getLayouts(marketVersion), MARKET_STATE_LAYOUT = _Market$getLayouts2.state; //@ts-ignore

            market = MARKET_STATE_LAYOUT.decode(Uint8Array.from(marketInfo.data));
            marketBaseVault = market.baseVault, marketQuoteVault = market.quoteVault, marketBids = market.bids, marketAsks = market.asks, marketEventQueue = market.eventQueue; // const poolKeys: LiquidityPoolKeys;

            return _context12.abrupt("return", _objectSpread(_objectSpread({}, poolKeys), {
              marketBaseVault: marketBaseVault,
              marketQuoteVault: marketQuoteVault,
              marketBids: marketBids,
              marketAsks: marketAsks,
...
function findPoolIdByBaseAndQuoteMintDevnet(_x15, _x16) {
  return _findPoolIdByBaseAndQuoteMintDevnet.apply(this, arguments);
}

function _findPoolIdByBaseAndQuoteMintDevnet() {
  _findPoolIdByBaseAndQuoteMintDevnet = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(base, quote) {
    var poolKeysList, keys;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            _context13.prev = 0;
            _context13.next = 3;
            return fetchAllPoolKeysDevnet(new _web.Connection((0, _web.clusterApiUrl)("devnet")));

          case 3:
            poolKeysList = _context13.sent;
            keys = poolKeysList.find(function (el) {
              return el.baseMint.toString() == base.toString() && el.quoteMint.toString() == quote.toString();
            });
          ...
          case 7:
            return _context13.abrupt("return", keys.id.toString());

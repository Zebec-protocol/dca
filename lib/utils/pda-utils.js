...
function _findProgramAddress() {
	_findProgramAddress = _asyncToGenerator(
		/*#__PURE__*/ _regeneratorRuntime().mark(function _callee(seeds) {
			var programId,
				_args = arguments;
...
function _findVaultAddress() {
	_findVaultAddress = _asyncToGenerator(
		/*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(owner, dcaAccount) {
...
function _findAssociatedTokenAddress() {
	_findAssociatedTokenAddress = _asyncToGenerator(
		/*#__PURE__*/ _regeneratorRuntime().mark(function _callee3(owner, mint) {
					...
					switch ((_context3.prev = _context3.next)) {
						case 0:
							...
							return findProgramAddress(
								[owner.toBuffer(), _splToken.TOKEN_PROGRAM_ID.toBuffer(), mint.toBuffer()],

...
function _fetchPoolKeys() {
	_fetchPoolKeys = _asyncToGenerator(
		/*#__PURE__*/ _regeneratorRuntime().mark(function _callee(connection, poolId) {
			var version,
				serumVersion,
				marketVersion,
				programId,
					...
					switch ((_context.prev = _context.next)) {
						...
						case 18:
							...
							(_Market$getLayouts = _raydiumSdk.Market.getLayouts(marketVersion)),
								(MARKET_STATE_LAYOUT = _Market$getLayouts.state); // @ts-ignore
...
function _fetchAllPoolKeys() {
	_fetchAllPoolKeys = _asyncToGenerator(
					...
					while (1) {
						switch ((_context2.prev = _context2.next)) {
							...
							case 3:
								...
								poolKeysList = [].concat(
									_toConsumableArray(
										(_response$data$offici = response.data.official) !== null && _response$data$offici !== void 0
											? _response$data$offici
											: [],
									),
									_toConsumableArray(
										(_response$data$unOffi = response.data.unOfficial) !== null && _response$data$unOffi !== void 0
											? _response$data$unOffi
											: [],
									),
								);
...
function _findPoolIdByBaseAndQuoteMint() {
	_findPoolIdByBaseAndQuoteMint = _asyncToGenerator(
		/*#__PURE__*/ _regeneratorRuntime().mark(function _callee3(base, quote) {

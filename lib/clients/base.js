...
var DcaClient = /*#__PURE__*/function () {
  ...
  _createClass(DcaClient, [{
    ...
    value: function () {
      var _makeInitializeTransaction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(owner, mint, dcaAccount, flag, startTime, dcaAmount, dcaTime) {
        var vault, _startTime, _dcaTime, _dcaAmount, mintInfo, minimumAmountOut, txn;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                _startTime = new _bn.default(startTime.toFixed());
                _dcaTime = new _bn.default(dcaTime.toFixed());
                _dcaAmount = new _bn.default(0);

                if (!(flag == _dcaAccount.DcaFlag["MINT-SOL"])) {
                  _context3.next = 14;
                  break;
                }
              ...
              case 14:
                _dcaAmount = (0, _utils.convertToLamports)(dcaAmount);

              case 15:
                minimumAmountOut = _dcaAmount;
      ...
      function makeInitializeTransaction(_x7, _x8, _x9, _x10, _x11, _x12, _x13) {
    ...
    value: function () {
      ...
      function makeWithdrawTokenTransaction(_x14, _x15, _x16, _x17) {
    ...
    value: function () {
      ...
      function makeWithdrawSolTransaction(_x18, _x19, _x20, _x21) {
    ...
    value: function () {
      var _makeSwapFromSolTransaction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(owner, mint, dcaAccount) {
        var vault, vaultNativeMintAccount, vaultTokenAccount, poolKeyId, poolKeys, poolInfo, dcaInfo, uiAmount, amountIn, currencyOut, slippage, _Liquidity$computeAmo, minAmountOut, txn;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 24:
                ...
                uiAmount = new _bignumber.default(dcaInfo.dcaAmount.toString()).div(new _bignumber.default(_web.LAMPORTS_PER_SOL));
                console.log(uiAmount.toFixed());
                console.log(poolInfo.baseDecimals);
                amountIn = new _raydiumSdk.TokenAmount(new _raydiumSdk.Token(poolKeys.baseMint, poolInfo.baseDecimals), uiAmount.toFixed(), false);
                currencyOut = new _raydiumSdk.Token(poolKeys.quoteMint, poolInfo.quoteDecimals);
                slippage = new _raydiumSdk.Percent(3, 100);
      ...
      function makeSwapFromSolTransaction(_x22, _x23, _x24) {
    ...
    value: function () {
      var _makeSwapToSolTransaction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(owner, mint, dcaAccount) {
        var vault, vaultTokenAccount, vaultNativeMintAccount, poolKeyId, poolKeys, poolInfo, dcaInfo, mintInfo, uiAmount, amountIn, currencyOut, slippage, _Liquidity$computeAmo2, minAmountOut, txn;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 25:
                ...
                uiAmount = new _bignumber.default(dcaInfo.dcaAmount.toString()).div(new _bignumber.default(Math.pow(10, mintInfo.decimals)));
                amountIn = new _raydiumSdk.TokenAmount(new _raydiumSdk.Token(poolKeys.baseMint, poolInfo.baseDecimals), uiAmount.toString(), false);
                currencyOut = new _raydiumSdk.Token(poolKeys.quoteMint, poolInfo.quoteDecimals);
                slippage = new _raydiumSdk.Percent(3, 100);
      ...
      function makeSwapToSolTransaction(_x25, _x26, _x27) {
    ...
    value: function () {
      ...
      function makeFundTokenTransaction(_x28, _x29, _x30, _x31) {
    ...
    value: function () {
      ...
      function makeFundSolTransaction(_x32, _x33, _x34, _x35) {

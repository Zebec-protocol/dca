	...
	_createClass(DcaClient, [
		{
			...
			value: (function () {
				var _makeDepositTokenTransaction = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee(owner, mint, amount) {
								...
								while (1) {
									switch ((_context.prev = _context.next)) {
										...
										case 16:
											...
											txn = new _web.Transaction().add(
												_instruction.DcaInstruction.depositToken(
													owner,
													vault,
													mint,
		...
		},
		{
			...
			value: (function () {
				var _makeDepositSolTransaction = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(owner, mint, amount) {
								...
								while (1) {
									switch ((_context2.prev = _context2.next)) {
										...
										case 13:
											...
											txn = new _web.Transaction().add(
												_instruction.DcaInstruction.depositSol(
													owner,
													vaultAddress,
													mint,
													_splToken.NATIVE_MINT,
		...
		},
		{
			...
			value: (function () {
				var _makeInitializeTransaction = _asyncToGenerator(
								...
								while (1) {
									switch ((_context3.prev = _context3.next)) {
										...
										case 8:
											...
											txn = new _web.Transaction().add(
												_instruction.DcaInstruction.initialize(
													owner,
													vault,
													dcaAccount,
													_startTime,
		...
		},
		{
			...
			value: (function () {
				var _makeWithdrawTokenTransaction = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee4(owner, mint, dcaAccount, amount) {
								...
								while (1) {
									switch ((_context4.prev = _context4.next)) {
										...
										case 12:
											...
											txn = new _web.Transaction().add(
												_instruction.DcaInstruction.withdrawToken(
													owner,
													vaultAddress,
													mint,
													ownerTokenAccount,
		...
		},
		{
			...
			value: (function () {
				var _makeWithdrawSolTransaction = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee5(owner, mint, dcaAccount, amount) {
						var vaultAddress,
							ownerTokenAccount,
								...
								while (1) {
									switch ((_context5.prev = _context5.next)) {
										...
										case 15:
											...
											txn = new _web.Transaction().add(
												_instruction.DcaInstruction.withdrawSol(
													owner,
													vaultAddress,
													mint,
													ownerTokenAccount,
		...
		},
		{
			...
			value: (function () {
				var _makeSwapFromSolTransaction = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee6(owner, mint, dcaAccount) {
						var vault,
							...
							function _callee6$(_context6) {
								while (1) {
									switch ((_context6.prev = _context6.next)) {
										...
										case 24:
											amount = new _bignumber.default(dcaInfo.dcaAmount.toString()).div(
												new _bignumber.default(_web.LAMPORTS_PER_SOL),
											);
											amountIn = new _raydiumSdk.TokenAmount(
												new _raydiumSdk.Token(poolKeys.baseMint, poolInfo.baseDecimals),
												amount.toFixed(),
												false,
											);
											...
											(_Liquidity$computeAmo = _raydiumSdk.Liquidity.computeAmountOut({
												...
												(amountOut = _Liquidity$computeAmo.amountOut),
												(minAmountOut = _Liquidity$computeAmo.minAmountOut),
												(currentPrice = _Liquidity$computeAmo.currentPrice),
												(executionPrice = _Liquidity$computeAmo.executionPrice),
												(priceImpact = _Liquidity$computeAmo.priceImpact),
												(fee = _Liquidity$computeAmo.fee);
											txn = new _web.Transaction().add(
												_instruction.DcaInstruction.swapFromSol(
		...
		},
		{
			...
			value: (function () {
				var _makeSwapToSolTransaction = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee7(owner, mint, dcaAccount) {
						var vault,
							vaultTokenAccount,
							vaultNativeMintAccount,
							poolKeyId,
								...
								while (1) {
									switch ((_context7.prev = _context7.next)) {
										...
										case 25:
											...
											amount = new _bignumber.default(dcaInfo.dcaAmount.toString()).div(
												new _bignumber.default(Math.pow(10, mintInfo.decimals)),
											);
											amountIn = new _raydiumSdk.TokenAmount(
												new _raydiumSdk.Token(poolKeys.baseMint, poolInfo.baseDecimals),
												amount.toString(),
											...
											(_Liquidity$computeAmo2 = _raydiumSdk.Liquidity.computeAmountOut({
												...
												(amountOut = _Liquidity$computeAmo2.amountOut),
												(minAmountOut = _Liquidity$computeAmo2.minAmountOut),
												(currentPrice = _Liquidity$computeAmo2.currentPrice),
												(executionPrice = _Liquidity$computeAmo2.executionPrice),
												(priceImpact = _Liquidity$computeAmo2.priceImpact),
												(fee = _Liquidity$computeAmo2.fee);
											txn = new _web.Transaction().add(
												_instruction.DcaInstruction.swapToSol(
													poolKeys.programId,
													poolKeys.id, // ammAddress
													poolKeys.authority, // ammAuthorityAddress
													poolKeys.openOrders, // ammOpenOrderAddress
		...
		},
		{
			...
			value: (function () {
				var _makeFundTokenTransaction = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee8(owner, mint, dcaAccount, amount) {
								...
								while (1) {
									switch ((_context8.prev = _context8.next)) {
										...
										case 12:
											...
											transferAmount = (0, _utils.convertToLamports)(amount, mintInfo.decimals);
											txn = new _web.Transaction().add(
												_instruction.DcaInstruction.fundToken(
													owner,
													vault,
													mint,
													ownerTokenAccount,
		...
		},
		{
			...
			value: (function () {
				var _makeFundSolTransaction = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee9(owner, mint, dcaAccount, amount) {
								...
								while (1) {
									switch ((_context9.prev = _context9.next)) {
										...
										case 12:
											...
											transferAmount = (0, _utils.convertToLamports)(amount);
											txn = new _web.Transaction().add(
												_instruction.DcaInstruction.fundSol(
													owner,
													vault,
													mint,
													_splToken.NATIVE_MINT,

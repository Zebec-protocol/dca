	...
	_createClass(DcaOnlineClient, [
		{
			...
			value: (function () {
				var _signAndSendTransaction = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee(txn, signers) {
		...
		},
		{
			key: "depositToken",
			value: (function () {
				var _depositToken = _asyncToGenerator(
		...
		},
		{
			key: "depositSol",
			value: (function () {
				var _depositSol = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee3(owner, mint, amount) {
		...
		},
		{
			key: "withdrawToken",
			value: (function () {
				var _withdrawToken = _asyncToGenerator(
		...
		},
		{
			key: "withdrawSol",
			value: (function () {
				var _withdrawSol = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee6(owner, mint, dcaAccount, amount) {
						var transaction, signature;
						return _regeneratorRuntime().wrap(
		...
		},
		{
			key: "swapFromSol",
			value: (function () {
				var _swapFromSol = _asyncToGenerator(
		...
		},
		{
			key: "swapToSol",
			value: (function () {
				var _swapToSol = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee8(owner, mint, dcaAccount) {
						var transaction, signature;
						return _regeneratorRuntime().wrap(
		...
		},
		{
			key: "fundToken",
			value: (function () {
				var _fundToken = _asyncToGenerator(
		...
		},
		{
			key: "fundSol",
			value: (function () {
				var _fundSol = _asyncToGenerator(
					/*#__PURE__*/ _regeneratorRuntime().mark(function _callee10(owner, mint, dcaAccount, amount) {
						var transaction, signature;
						return _regeneratorRuntime().wrap(

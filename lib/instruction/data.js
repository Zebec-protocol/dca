...
exports.WithdrawTokenData = exports.WithdrawSolData = exports.SwapToSolData = exports.SwapFromSolData = exports.InitializeData = exports.FundTokenData = exports.FundSolData = exports.DepositTokenData = exports.DepositSolData = void 0;
...
var initializeSchema = new Map([[InitializeData, {
  kind: "struct",
  fields: [["instruction", "u8"], ["startTime", "u64"], ["dcaAmount", "u64"], ["dcaTime", "u64"], ["minimumAmountOut", "u64"]]
}]]);
var depositSolSchema = new Map([[DepositSolData, {
  kind: "struct",
  fields: [["instruction", "u8"], ["amount", "u64"]]
}]]);
var swapToSolSchema = new Map([[SwapToSolData, {
  kind: "struct",
  fields: [["instruction", "u8"], ["minimumAmountOut", "u64"]]
}]]);
var swapFromSolSchema = new Map([[SwapFromSolData, {
  kind: "struct",
  fields: [["instruction", "u8"], ["minimumAmountOut", "u64"]]
}]]);
...
var withdrawSolSchema = new Map([[WithdrawSolData, {
  kind: "struct",
  fields: [["instruction", "u8"], ["transferAmount", "u64"]]
}]]);
var fundTokenSchema = new Map([[FundTokenData, {
  kind: "struct",
  fields: [["instruction", "u8"], ["transferAmount", "u64"]]
}]]);
var fundSolSchema = new Map([[FundSolData, {
  kind: "struct",
  fields: [["instruction", "u8"], ["transferAmount", "u64"]]
}]]);
